...
const buttonStyle = {
  ...
  primary: {
    ...
    boxShadow:
      ...
      "0 2px 2px 0px rgba(195, 229, 234, 0.28), 0 3px 1px -2px rgba(0, 0, 0, 0.12), 0 1px 5px 0px rgba(195, 229, 234, 0.2)",
    "&:hover,&:focus": {
      backgroundColor: primaryColor,
      boxShadow:
        // "0 14px 26px -12px rgba(156, 39, 176, 0.42), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(156, 39, 176, 0.2)"
        "0 14px 26px -12px rgba(195, 229, 234, 0.42), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(195, 229, 234, 0.2)"
    }
  },
  info: {
